...
// ../content/concepts/introduction-to-trigonometry/01-what-is-trigonometry.json
var what_is_trigonometry_default = {
  ...
  theory: {
    introduction: "Trigonometry is the study of relationships between angles and lengths, especially in triangles. It gives us a systematic way to use an angle to understand unknown distances, heights, directions, and other geometric quantities.",
    sections: [
      {
        id: "meaning-of-trigonometry",
        title: "What does Trigonometry mean?",
        content: [
          {
            type: "paragraph",
            id: "trigonometry-definition",
            text: 'The word trigonometry comes from Greek roots meaning "triangle" and "measurement." At its core, trigonometry studies how the angles and sides of geometric figures are related.'
          },
          {
            type: "paragraph",
            id: "trigonometry-beyond-measuring-triangles",
            text: "Although triangles are where the subject begins, trigonometry eventually becomes a much broader language for describing rotation, circular motion, waves, periodic phenomena, and relationships between quantities."
          }
        ]
      },
      {
        id: "why-trigonometry-exists",
        title: "Why do we need Trigonometry?",
        content: [
          {
            type: "paragraph",
            id: "hidden-length-problem",
            text: "Imagine that you want to determine the height of a building, the distance to an object, or the direction in which something is moving, but measuring the required length directly is difficult or impossible. If you can measure suitable angles and some known lengths, trigonometry can help determine the quantities you cannot measure directly."
          },
          {
            type: "paragraph",
            id: "angle-length-relationship",
            text: "The key idea is that an angle can carry information about the relative lengths in a triangle. Trigonometry provides precise relationships that allow us to move between angular information and length information."
          }
        ]
      },
      {
        ...
        content: [
          {
            type: "paragraph",
            id: "triangle-height-example",
            text: "Suppose you stand some distance away from a vertical tower and measure the angle from the ground to the top of the tower. Together with the distance you know, this forms a right triangle. The geometry of that triangle contains enough information to determine the tower's height."
          },
          {
            type: "paragraph",
            id: "from-geometry-to-trigonometry",
            text: "This is the kind of problem that motivates trigonometry: instead of physically measuring an inaccessible length, we use the relationships inside a triangle to calculate it."
          }
        ]
      },
      {
        id: "where-it-leads",
        title: "Where does Trigonometry go from here?",
        content: [
          {
            type: "paragraph",
            id: "trig-foundation",
            text: "To understand these relationships, we first need to understand angles properly: what an angle represents, how it is measured, and how an angle can be viewed as a rotation."
          },
          {
            type: "paragraph",
            id: "trig-learning-path",
            text: "We will then connect angles with right triangles, discover why certain ratios remain connected to an angle, and eventually build the trigonometric functions such as sine, cosine, and tangent."
          }
        ]
      }
    ]
  ...
  examples: [
    {
      id: "tower-height-motivation",
      question: "You are standing a known distance from a tower and can measure the angle from the ground to the top. How could this information help you determine the tower's height?",
      solution: "The ground, the tower, and the line of sight form a right triangle. Once the relevant angle and known distance are identified, a trigonometric relationship can be used to determine the unknown height. The exact ratio used will be introduced when we study trigonometric ratios."
    }
  ],
  key_ideas: [
    "Trigonometry studies relationships between angles and lengths.",
    "It begins with triangles but eventually applies to rotation, circles, waves, and periodic phenomena.",
    "One major purpose of trigonometry is to determine quantities that are difficult or impossible to measure directly.",
    "Angles can provide information about relative side lengths in a triangle.",
    "The natural starting point for learning trigonometry is understanding angles and their measurement."
  ],
  misconceptions: [
    "Trigonometry is only about memorizing sine, cosine, and tangent formulas.",
    "Trigonometry is only useful for solving textbook triangle problems.",
    "Every trigonometry problem requires a calculator.",
    "Trigonometry is completely separate from geometry."
  ],
  explorations: [],
  sources: []
};
        ...
        content: [
          {
            ...
            text: "Just as length can be measured in different units, angles can be represented using different measurement systems. The physical rotation does not change when the measurement system changes; only the numerical representation changes."
          },
          {
            type: "paragraph",
            id: "degree-system-motivation",
            text: "One familiar system divides a complete revolution into 360 equal parts. Each part is one degree, so a complete revolution measures 360 degrees. This makes a quarter-turn 90 degrees and a half-turn 180 degrees."
          },
          {
            type: "paragraph",
            id: "units-not-geometry",
            text: "The number 360 is a convention for the degree system, not a property that every possible angle-measurement system must use. Trigonometry also uses a measurement system built from the geometry of circles themselves."
          }
        ]
      },
      {
        ...
        content: [
          {
            type: "paragraph",
            id: "one-degree",
            text: "In the degree system, one degree represents one three-hundred-sixtieth of a complete revolution. Therefore, the numerical degree measure can be interpreted as how many of these equal parts of a full turn the rotation contains."
          },
          {
            type: "paragraph",
            id: "common-revolution-measures",
            text: "A quarter revolution corresponds to 90 degrees, a half revolution to 180 degrees, three-quarters of a revolution to 270 degrees, and one complete revolution to 360 degrees."
          },
          {
            type: "paragraph",
            id: "multiple-revolutions-degrees",
            text: "Because a rotation can continue beyond one revolution, angles can have degree measures greater than 360 degrees or negative degree measures when the rotation is clockwise."
          }
        ]
      },
      {
        ...
        content: [
          {
            type: "paragraph",
            id: "degree-is-convention",
            text: "Degrees are useful, but their definition begins with the convention of dividing a full revolution into 360 equal parts. A circle also contains another natural relationship: its radius and the arc traced by a central angle."
          },
          {
            type: "paragraph",
            id: "natural-circle-measure",
            text: "Because the ratio of arc length to radius depends only on the angle, that ratio can itself be used to measure the angle. This leads to radian measure."
          },
          {
            type: "paragraph",
            id: "bridge-to-next-file",
            text: "The next step is therefore to understand degrees and radians as two different ways of assigning numbers to the same rotation, how they are related, and why radians become especially natural when trigonometry is connected with circles and later mathematics."
          }
        ]
      }
    ]
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          {
            type: "paragraph",
            id: "origin-and-positive-x",
            text: "For trigonometric work, it is useful to place the center of the circle at the origin of the coordinate plane and use the positive x-axis as the starting direction. An angle arranged this way is in standard position."
          },
          {
            type: "paragraph",
            id: "initial-terminal-sides",
            text: "The positive x-axis is the initial side. After the specified rotation, the ray showing the final direction is the terminal side."
          },
          {
            type: "paragraph",
            id: "directed-rotation",
            text: "Positive angles rotate counterclockwise from the initial side, while negative angles rotate clockwise. This means the same circle can represent rotations in both directions."
          }
        ]
      },
      {
        ...
        content: [
          {
            type: "paragraph",
            id: "quadrant-definition",
            text: "The coordinate axes divide the plane into four regions called Quadrants I, II, III, and IV. As a terminal side rotates around a circle, it can point into any of these four regions or lie directly on an axis."
          },
          {
            type: "paragraph",
            id: "counterclockwise-quadrants",
            text: "Starting from the positive x-axis and rotating counterclockwise, the terminal side enters Quadrant I first, then Quadrant II, Quadrant III, and finally Quadrant IV before completing the revolution."
          },
          {
            type: "paragraph",
            id: "quadrant-intervals-degrees",
            text: "Within one positive revolution measured in degrees, Quadrant I lies between 0\xB0 and 90\xB0, Quadrant II between 90\xB0 and 180\xB0, Quadrant III between 180\xB0 and 270\xB0, and Quadrant IV between 270\xB0 and 360\xB0."
          },
          {
            type: "paragraph",
            id: "quadrant-intervals-radians",
            text: "The same regions can be described in radians: Quadrant I lies between 0 and \u03C0/2, Quadrant II between \u03C0/2 and \u03C0, Quadrant III between \u03C0 and 3\u03C0/2, and Quadrant IV between 3\u03C0/2 and 2\u03C0."
          }
        ]
      },
      {
        ...
        content: [
          {
            type: "paragraph",
            id: "quadrantal-angles",
            text: "Some angles do not end inside a quadrant. Their terminal side lies directly on one of the coordinate axes. These are called quadrantal angles."
          },
          {
            type: "paragraph",
            id: "important-axis-directions",
            text: "Within one counterclockwise revolution, the four main axis directions occur at 0\xB0, 90\xB0, 180\xB0, and 270\xB0, or equivalently at 0, \u03C0/2, \u03C0, and 3\u03C0/2 radians."
          },
          {
            type: "paragraph",
            id: "why-axis-positions-matter",
            text: "These positions form the boundaries between quadrants and later become important because the coordinates of points on the axes have a particularly simple form."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        title: "A Common Angle Can Be Used as a Reference",
        content: [
          {
            type: "paragraph",
            id: "reference-angle-idea",
            text: "When an angle lies in a quadrant, it can be compared with the nearest horizontal axis. The smaller positive acute angle between the terminal side and the horizontal axis is called the reference angle."
          },
          {
            type: "paragraph",
            id: "reference-angle-purpose",
            text: "The reference angle captures the basic geometric size of the angle while temporarily ignoring which quadrant contains the terminal side. This will later help connect angles in different quadrants to familiar acute-angle geometry."
          },
          {
            type: "paragraph",
            id: "reference-angle-not-same-angle",
            text: "A reference angle is not the original angle. It is an associated acute angle used as a geometric comparison. The original angle still contains information about its direction and quadrant."
          }
        ]
      },
      {
    ...
    sections: [
      {
        ...
        title: "Why can a ratio become a function of an angle?",
        content: [
          {
            type: "paragraph",
            id: "fixed-angle-fixed-ratios",
            text: "Take any acute angle and construct a right triangle containing that angle. You can make the triangle larger or smaller while keeping the angle unchanged. The resulting triangles are similar, so their corresponding side ratios remain constant."
          },
          {
            type: "paragraph",
            id: "ratio-belongs-to-angle",
            text: "Because the ratio does not depend on the particular size of the triangle, it can be associated with the angle itself. This is the fundamental idea behind a trigonometric function."
          },
          {
            type: "paragraph",
            id: "three-basic-ratios",
            text: "Relative to a chosen acute angle, there are three especially important ratios: opposite to hypotenuse, adjacent to hypotenuse, and opposite to adjacent. These are named sine, cosine, and tangent."
          }
        ]
      },
      {
        ...
        content: [
          {
            type: "paragraph",
            id: "hypotenuse-reminder",
            text: "The hypotenuse is always the side opposite the 90\xB0 angle, so it is also the longest side of a right triangle."
          },
          {
            type: "paragraph",
            id: "opposite-side",
            text: "For a chosen acute angle \u03B8, the opposite side is the side directly across from \u03B8. It does not touch the chosen angle."
          },
          {
            type: "paragraph",
            id: "adjacent-side",
            text: "For the same chosen angle \u03B8, the adjacent side is the leg that touches \u03B8 but is not the hypotenuse."
          },
          {
            type: "paragraph",
            id: "labels-depend-on-angle",
            text: "Opposite and adjacent are relative labels. If you choose the other acute angle of the same triangle, the old opposite side becomes the new adjacent side, and vice versa."
          }
        ]
      },
      {
        ...
        content: [
          {
            type: "paragraph",
            id: "sine-definition",
            text: "The sine of an acute angle is the ratio of the length of the side opposite the angle to the length of the hypotenuse."
          },
          {
            type: "paragraph",
            id: "sine-meaning",
            text: "For a fixed angle, this ratio tells us how large the opposite component of the right triangle is relative to the triangle's overall longest side."
          }
        ]
      },
      {
        ...
        content: [
          {
            ...
            text: "The cosine of an acute angle is the ratio of the length of the side adjacent to the angle to the length of the hypotenuse."
          },
          {
            type: "paragraph",
            id: "cosine-meaning",
            text: "For a fixed angle, this ratio describes the adjacent component relative to the hypotenuse."
          }
        ]
      },
      {
        ...
        content: [
          {
            ...
            text: "The tangent of an acute angle is the ratio of the length of the side opposite the angle to the length of the side adjacent to the angle."
          },
          {
            type: "paragraph",
            id: "tangent-meaning",
            text: "Tangent compares the two legs of the right triangle. In applications involving a line rising from the horizontal, this ratio naturally describes how steeply the line rises."
          }
        ]
      },
      {
        ...
        content: [
          {
            type: "paragraph",
            id: "sohcahtoa",
            text: "A common mnemonic is SOH-CAH-TOA: Sine = Opposite/Hypotenuse, Cosine = Adjacent/Hypotenuse, Tangent = Opposite/Adjacent."
          },
          {
            type: "paragraph",
            id: "mnemonic-not-concept",
            text: "The mnemonic is useful for recall, but the deeper reason these formulas work is similarity: a fixed angle produces similar right triangles, and similarity keeps the corresponding ratios constant."
          }
        ]
      },
      {
        ...
        content: [
          {
            type: "paragraph",
            id: "example-3-4-5",
            text: "Consider a right triangle with side lengths 3, 4, and 5. If the chosen angle has opposite side 3, adjacent side 4, and hypotenuse 5, then its sine is 3/5, its cosine is 4/5, and its tangent is 3/4."
          },
          {
            type: "paragraph",
            id: "scale-example",
            text: "Now enlarge the triangle by a factor of 2. Its corresponding sides become 6, 8, and 10. The ratios become 6/10, 8/10, and 6/8, which simplify to exactly the same values. The triangle changed size, but the three trigonometric ratios did not change."
          }
        ]
      },
      {
        ...
        content: [
          {
            ...
            text: "Some angles occur naturally in special right triangles, especially 30\xB0, 45\xB0, and 60\xB0. Their side-length relationships allow the corresponding trigonometric ratios to be determined exactly rather than approximated with a calculator."
          },
          {
            type: "paragraph",
            id: "preview-not-table",
            text: "The important point is not to memorize a table yet. The exact values can be derived from the geometry of special triangles. This will make the familiar values feel like consequences of geometry rather than isolated facts."
          }
        ]
      },
      {
  ...
  formulas: [
    {
      ...
      explanation: "For an acute angle in a right triangle, sine is the ratio of the opposite side to the hypotenuse."
    },
    {
      id: "cosine",
      name: "Cosine",
      expression: "cos(\u03B8) = adjacent / hypotenuse",
      explanation: "For an acute angle in a right triangle, cosine is the ratio of the adjacent leg to the hypotenuse."
    },
    {
      id: "tangent",
      name: "Tangent",
      expression: "tan(\u03B8) = opposite / adjacent",
      explanation: "For an acute angle in a right triangle, tangent is the ratio of the opposite leg to the adjacent leg."
    },
    {
      id: "tangent-as-sine-cosine",
      name: "Tangent as a Quotient",
      expression: "tan(\u03B8) = sin(\u03B8) / cos(\u03B8)",
      explanation: "Dividing opposite/hypotenuse by adjacent/hypotenuse cancels the common hypotenuse and gives opposite/adjacent."
    }
  ],
  examples: [
    {
...
// ../content/concepts/trigonometricFunctions/trig-equations-01-what-are-equations.json.json
var trig_equations_01_what_are_equations_json_default = {
  ...
  theory: {
    introduction: "A trigonometric equation is an equation involving one or more trigonometric functions in which the unknown is usually an angle.",
    sections: [
      {
        id: "definition",
        title: "Definition",
        content: [
          {
            type: "paragraph",
            text: "Examples include sin(x) = 1/2, cos(x) = 0, and tan(x) = 1. The goal is to find every value of x that makes the equation true.",
            id: "definition-paragraph-1"
          }
        ]
      },
      {
        id: "difference-from-algebra",
        title: "How Trigonometric Equations Differ",
        content: [
          {
            type: "paragraph",
            text: "Unlike many basic algebraic equations, trigonometric equations can have multiple or infinitely many solutions because trigonometric functions are periodic.",
            id: "difference-from-algebra-paragraph-1"
          }
        ]
      }
    ]
  ...
  examples: [
    {
      ...
      solution: "Yes. It contains the trigonometric function sine and has x as the unknown angle."
    }
  ],
  key_ideas: [
    "The unknown is usually an angle.",
    "A trigonometric equation may have multiple solutions.",
    "Periodic behavior is responsible for repeated solutions."
  ],
  misconceptions: [
    "Thinking a trigonometric equation must have only one answer.",
    "Confusing a trigonometric identity with a trigonometric equation."
  ],
  explorations: [
    {
...
var trig_equations_02_nature_of_solutions_default = {
  ...
  theory: {
    introduction: "The periodic nature of trigonometric functions means that solutions repeat at regular intervals.",
    sections: [
      {
        id: "periodicity",
        title: "Periodicity",
      ...
      {
        id: "general-and-restricted",
        title: "General and Restricted Solutions",
        content: [
          {
            type: "paragraph",
  ...
  examples: [
    {
      id: "period-example",
      question: "If x = \u03C0/6 is a solution of sin(x) = 1/2, give another solution.",
      solution: "Because sine has period 2\u03C0, x = \u03C0/6 + 2\u03C0 is also a solution."
    }
  ],
  key_ideas: [
    "Trigonometric functions are periodic.",
    "General solutions describe infinitely many solutions.",
    "Restricted intervals limit which solutions are accepted."
  ],
  misconceptions: [
    "Assuming the inverse trigonometric function gives every solution.",
    "Forgetting the period when generating additional solutions."
  ],
  explorations: [
    {
...
var trig_equations_03_basic_equations_default = {
  ...
  theory: {
    introduction: "Basic trigonometric equations can be solved by isolating a trigonometric function and using the unit circle or inverse trigonometric functions.",
    sections: [
      {
        id: "sine",
        title: "Sine Equations",
        content: [
          {
            type: "paragraph",
  ...
  formulas: [
    {
      ...
      explanation: "Represents all real solutions when \u22121 \u2264 a \u2264 1."
    },
    {
      id: "cosine-general",
  ...
  examples: [
    {
      ...
      solution: "The reference angle is \u03C0/6. Sine is positive in Quadrants I and II, so x = \u03C0/6 and 5\u03C0/6."
    },
    {
      id: "cosine-example",
      question: "Solve cos(x) = \u2212\u221A2/2 for 0 \u2264 x < 2\u03C0.",
      solution: "The reference angle is \u03C0/4. Cosine is negative in Quadrants II and III, so x = 3\u03C0/4 and 5\u03C0/4."
    },
    {
      id: "tangent-example",
      question: "Solve tan(x) = \u221A3.",
      solution: "The reference angle is \u03C0/3. Therefore x = \u03C0/3 + n\u03C0, where n \u2208 \u2124."
    }
  ],
  key_ideas: [
    "Isolate the trigonometric function first.",
    "Use the unit circle to find all angles.",
    "Use inverse functions to obtain reference or principal angles.",
    "Use periodicity to generate additional solutions."
  ],
  misconceptions: [
    "Giving only the calculator's inverse-trigonometric answer.",
    "Forgetting the second solution for sine or cosine.",
...
var trig_equations_04_reciprocal_function_equations_default = {
  ...
  theory: {
    introduction: "Equations involving secant, cosecant, and cotangent can often be rewritten using their reciprocal relationships.",
    sections: [
      {
  ...
  formulas: [
    {
      ...
      explanation: "These identities convert reciprocal functions into familiar trigonometric functions."
    }
  ],
  examples: [
    {
      ...
      solution: "Rewrite as cos(x) = 1/2. Therefore x = \u03C0/3 and 5\u03C0/3."
    },
    {
      id: "csc-example",
      question: "Solve csc(x) = \u22121 for 0 \u2264 x < 2\u03C0.",
      solution: "Rewrite as sin(x) = \u22121. Therefore x = 3\u03C0/2."
    }
  ],
  key_ideas: [
    "Rewrite reciprocal functions when useful.",
    "Check domain restrictions.",
    "Do not include values where the original function is undefined."
  ],
  misconceptions: [
    "Treating sec(x) as 1/sin(x).",
    "Ignoring undefined values.",
    "Checking only the transformed equation instead of the original one."
  ],
  explorations: [
    {
...
var trig_equations_05_factoring_default = {
  ...
  theory: {
    introduction: "Some trigonometric equations can be factored using familiar algebraic techniques before solving each factor.",
    sections: [
      {
        id: "zero-product",
  ...
  formulas: [
    {
      ...
      explanation: "Used after factoring an equation."
    }
  ],
  examples: [
    {
      ...
      solution: "Factor: sin(x)(2sin(x) \u2212 1) = 0. Thus sin(x) = 0 or sin(x) = 1/2. The solutions are 0, \u03C0, \u03C0/6, and 5\u03C0/6."
    }
  ],
  key_ideas: [
    "Treat trigonometric expressions algebraically when possible.",
    "Factor before applying more complicated identities.",
    "Solve every resulting equation."
  ],
  misconceptions: [
    "Dividing by sin(x) and accidentally removing sin(x) = 0 solutions.",
...
var trig_equations_06_quadratic_equation_default = {
  ...
  theory: {
    introduction: "Some trigonometric equations have the form of quadratic equations when one trigonometric function is treated as the variable.",
    sections: [
      {
        id: "substitution",
  ...
  formulas: [
    {
      ...
      explanation: "A repeated trigonometric expression can sometimes be represented by u and solved as a quadratic."
    }
  ],
  examples: [
    {
      id: "quadratic-example",
      question: "Solve 2cos\xB2(x) \u2212 3cos(x) + 1 = 0.",
      solution: "Let u = cos(x). Then 2u\xB2 \u2212 3u + 1 = 0, which factors as (2u \u2212 1)(u \u2212 1) = 0. Therefore cos(x) = 1/2 or cos(x) = 1. Solve each equation separately."
    }
  ],
  key_ideas: [
    "Recognize quadratic structure.",
    "Use substitution when helpful.",
    "Convert every algebraic solution back into an angle."
  ],
  misconceptions: [
    "Stopping after solving the quadratic.",
    "Forgetting to check whether the obtained trigonometric values are possible."
  ],
  explorations: [
    {
...
var trig_equations_07_identities_default = {
  ...
  theory: {
    introduction: "More complicated trigonometric equations can be transformed into solvable forms using identities already learned.",
    sections: [
      {
        id: "choose-identity",
      ...
      {
        id: "common-identities",
        title: "Commonly Useful Identities",
        content: [
          {
            type: "paragraph",
  ...
  formulas: [
    {
      ...
      explanation: "Useful for converting between sine and cosine."
    },
    {
      id: "double-angle-cosine",
      name: "Double-Angle Identity",
      expression: "cos(2x) = 1 \u2212 2sin\xB2(x)",
      explanation: "Can convert a double-angle expression into a squared trigonometric function."
    }
  ],
  examples: [
    {
      ...
      solution: "Rearrange to sin\xB2(x) = 1/2. Therefore sin(x) = \xB1\u221A2/2. The four solutions are \u03C0/4, 3\u03C0/4, 5\u03C0/4, and 7\u03C0/4."
    }
  ],
  key_ideas: [
    "Use identities strategically.",
    "Transform rather than randomly manipulate.",
    "Return to a basic trigonometric equation whenever possible."
  ],
  misconceptions: [
    "Using an identity without considering whether it simplifies the equation.",
    "Assuming every identity makes an equation easier."
  ],
  explorations: [
    {
...
var trig_equations_08_multipleAndCompostite_default = {
  ...
  theory: {
    introduction: "Equations containing angles such as 2x or 3x can produce more solutions within a given interval.",
    sections: [
      {
        id: "multiple-angle",
  ...
  formulas: [
    {
      ...
      name: "Basic Multiple-Angle Pattern",
      expression: "cos(2x) = 0  \u21D2  2x = \u03C0/2 + n\u03C0",
      explanation: "Solve for the multiple angle first, then divide by 2."
    }
  ],
  examples: [
    {
      ...
      solution: "2x = \u03C0/2 + n\u03C0. Therefore x = \u03C0/4 + n\u03C0/2. The solutions are \u03C0/4, 3\u03C0/4, 5\u03C0/4, and 7\u03C0/4."
    }
  ],
  key_ideas: [
    "Solve for the multiple angle first.",
    "Generate every solution in the relevant interval.",
    "Divide by the coefficient only after accounting for all solutions."
  ],
  misconceptions: [
    "Finding only one value of 2x.",
    "Dividing too early and losing solutions."
  ],
  explorations: [
    {
...
var trig_equations_09_RestrictedInterval_default = {
  ...
  theory: {
    introduction: "A restricted interval limits the set of acceptable solutions.",
    sections: [
      {
        id: "common-intervals",
      ...
      },
      {
        ...
        title: "Finding All Valid Solutions",
        content: [
          {
            type: "paragraph",
  ...
  key_ideas: [
    "The interval determines which answers are valid.",
    "Always check the endpoints.",
    "Use the unit circle to locate solutions."
  ],
  misconceptions: [
    "Giving a general solution when a restricted interval was requested.",
    "Missing a solution because only the principal angle was considered."
  ],
  explorations: [
    {
...
var trig_equations_10_extraneousSolutions_default = {
  ...
  theory: {
    introduction: "Algebraic transformations can sometimes introduce invalid candidates or remove valid solutions. Checking the original equation protects against these errors.",
    sections: [
      {
        id: "when-check",
  ...
  examples: [
    {
      ...
      solution: "Squaring can make two expressions equal even when their original signs were different. Therefore a candidate must be substituted into the original equation."
    }
  ],
  key_ideas: [
    "Always respect the original domain.",
    "Check candidates after transformations that may change the solution set.",
    "The original equation is the final authority."
  ],
  misconceptions: [
    "Assuming every algebraically obtained value is automatically valid.",
...
var trig_equations_11_generalSolution_default = {
  ...
  theory: {
    introduction: "When an interval is not specified, trigonometric equations are often expressed using a general solution that represents every possible angle.",
    sections: [
      {
  ...
  formulas: [
    {
      id: "sine-general",
      name: "Sine General Solution",
      expression: "sin(x) = a  \u21D2  x = (\u22121)\u207F sin\u207B\xB9(a) + n\u03C0, n \u2208 \u2124",
      explanation: "Represents all real solutions."
    },
    {
      id: "cosine-general",
      name: "Cosine General Solution",
      expression: "cos(x) = a  \u21D2  x = \xB1cos\u207B\xB9(a) + 2n\u03C0, n \u2208 \u2124",
      explanation: "Represents all real solutions."
    },
    {
      id: "tangent-general",
      name: "Tangent General Solution",
      expression: "tan(x) = a  \u21D2  x = tan\u207B\xB9(a) + n\u03C0, n \u2208 \u2124",
  ...
  examples: [
    {
      ...
      solution: "The reference angle is \u03C0/3. Since tangent repeats every \u03C0, x = \u03C0/3 + n\u03C0, where n \u2208 \u2124."
    }
  ],
  key_ideas: [
    "General solutions represent all solutions.",
  ...
  misconceptions: [
    ...
    "Giving only solutions in one revolution when a general solution is required."
  ],
  explorations: [
    {
...
var concepts = [
  ...
  trig_equations_01_what_are_equations_json_default,
...
// .wrangler/tmp/bundle-bIW51r/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-bIW51r/middleware-loader.entry.ts
